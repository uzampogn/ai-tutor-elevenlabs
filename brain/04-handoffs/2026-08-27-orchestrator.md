...
- **Evidence:** 582/582 tests green · live ingest wrote 23/23 digests, 0 failed · warm `/api/digest` 0.178s · drawer renders the persisted digest — `brain/03-build-reports/22-persist-article-digests/drawer.png` · full detail in `brain/03-build-reports/22-persist-article-digests/report.md`.
